// 1783830731675 is replaced by the Vite `sw-version-stamp` plugin at build time.
...
// Activate: delete every cache except the current one, then notify open tabs to reload
