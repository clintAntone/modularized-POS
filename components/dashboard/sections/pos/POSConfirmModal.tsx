                        ...
                        <div className="bg-slate-50 rounded-[28px] p-3 space-y-2">
                            ...
                            {totalDiscount > 0 && (
                                <div className="flex justify-between items-center px-3 py-0.5">
                                    <span className="text-xs font-bold text-rose-500 uppercase tracking-widest">Aggregate Reductions</span>
                        ...
                        <div className="bg-slate-50 rounded-[24px] p-4 flex items-center justify-between border border-slate-100">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs font-semibold text-slate-400 uppercase tracking-widest">Method selected</p>
                                </div>
                            </div>
                        </div>
                    </div>
