            ...
            >
                ...
                <div className="px-8 py-5 w-[15%]">
                    <div className="flex flex-col">
                        ...
                        <span className={`text-xs font-semibold uppercase tracking-widest mt-1 ${isBackfill ? 'text-amber-500' : 'text-slate-400 opacity-70'}`}>
                ...
                <div className="px-6 py-5 w-[17%]">
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex flex-col min-w-0">
                            <span className="font-bold text-slate-900 uppercase text-xs tracking-wider leading-tight">{branchName}</span>
                            <span className="text-xs font-bold text-slate-300 uppercase tracking-widest mt-0.5">Finalized Archive</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-6 py-5 w-[13%] text-right">
                    <div className="flex flex-col items-end gap-0.5">
                        ...
                        {vaultColValue > 0 && (
                            <span className="text-xs font-bold text-slate-300 uppercase tracking-widest whitespace-nowrap">
                                {vaultColLabel}
                            </span>
                        )}
                    </div>
            ...
            >
                ...
                <div className="grid grid-cols-3 gap-1.5 px-3 pb-3">
                    ...
                    <div className="bg-amber-50/60 rounded-xl px-3 py-2.5">
                        <p className="text-xs font-black text-amber-500 uppercase tracking-widest mb-1">Salary</p>
                        <p className="text-xs font-black text-amber-600 tabular-nums leading-none">₱{pay.toLocaleString()}</p>
                    </div>
                    <div className="bg-rose-50/60 rounded-xl px-3 py-2.5">
                        <p className="text-xs font-black text-rose-400 uppercase tracking-widest mb-1">Expenses</p>
                        <p className="text-xs font-black text-rose-500 tabular-nums leading-none">₱{exp.toLocaleString()}</p>
                    </div>
                </div>
