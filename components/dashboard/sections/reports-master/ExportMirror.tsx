    ...
    >
      <div className="flex justify-between items-start mb-12">
        <div>
          ...
          <p className="text-sm font-black text-emerald-600 uppercase tracking-wide mt-1">Official Branch Audit Log</p>
        </div>
        <div className="text-right">
          <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Registry ID</p>
      ...
      <div className="grid grid-cols-2 gap-12 mb-12 border-y border-slate-100 py-10">
        <div className="space-y-1">
          <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Audit Context</p>
          <h2 className="text-2xl font-bold">{branchName}</h2>
        </div>
        <div className="text-right space-y-1">
          <p className="text-xs font-medium text-slate-400 uppercase tracking-wide">Archive Date</p>
      ...
      <div className="grid grid-cols-4 gap-6 mb-12">
        <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100">
          <p className="text-xs font-medium text-slate-400 uppercase tracking-wide mb-2">Gross Yield</p>
        ...
        <div className="bg-slate-50 p-8 rounded-2xl border border-slate-100">
          <p className="text-xs font-medium text-slate-400 uppercase tracking-wide mb-2">Operational</p>
      ...
      <div className="space-y-6">
        <h3 className="text-lg font-semibold uppercase tracking-wide text-slate-900">Session Ledger Activity</h3>
        <div className="border border-slate-100 rounded-2xl overflow-hidden">
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-100 text-xs font-medium text-slate-400 uppercase tracking-wide">
