    ...
    <div className={`bg-white px-4 py-4 sm:px-6 sm:py-5 ${UI_THEME.radius.card} shadow-sm border border-slate-100 flex flex-col gap-4`}>
      ...
      <div className="flex items-center justify-between gap-3">
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-[8px] font-black text-slate-400 uppercase tracking-[0.3em]">Staff Directory</p>
      ...
      <div className="flex items-center gap-2">
        ...
        {(onExportCSV || onExportPDF) && (
          <div className="relative" ref={exportRef}>
            <button
              ...
              className={`flex items-center gap-1.5 h-9 px-3 bg-slate-50 text-slate-500 border border-slate-100 rounded-xl font-bold text-[10px] uppercase tracking-widest hover:bg-slate-100 transition-all active:scale-95 ${isExporting ? 'opacity-50 cursor-not-allowed' : ''}`}
            >
              {isExporting
        ...
        <div className="relative" ref={dropdownRef}>
          <button
            onClick={() => setOpen(v => !v)}
            className={`relative h-9 px-3 rounded-xl border transition-all text-[10px] font-bold uppercase tracking-widest flex items-center gap-1.5 ${
              open
          ...
          {open && (
            <div className="absolute right-0 top-[calc(100%+8px)] w-56 bg-white rounded-2xl border border-slate-100 shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-150">
              ...
              <div className="px-4 pt-4 pb-2">
                <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-2">Designation</p>
                <div className="space-y-1">
                  ...
                  >
                    ...
                    <span className="text-[10px] font-black uppercase tracking-widest">All Roles</span>
                  </button>
              ...
              <div className="px-4 py-3 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                <span className="text-[8px] font-black text-slate-400 uppercase tracking-widest">{totalShowing} showing</span>
                {hasActiveFilters && (
                  <button
