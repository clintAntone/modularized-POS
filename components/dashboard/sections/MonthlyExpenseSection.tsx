      ...
      <div className={`bg-white p-4 sm:p-6 md:p-8 ${UI_THEME.radius.card} shadow-sm border border-slate-100 flex flex-col gap-4 sm:gap-6 md:gap-8`}>
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="h-10 sm:h-14 px-4 sm:px-10 bg-emerald-600 text-white rounded-xl sm:rounded-[24px] font-bold text-[10px] sm:text-[11px] uppercase tracking-widest shadow-xl hover:bg-emerald-700 transition-all active:scale-95 shrink-0 whitespace-nowrap flex items-center justify-center gap-2"
          >
