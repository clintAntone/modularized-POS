      ...
      <div className={`${UI_THEME.layout.mainPadding} ${UI_THEME.layout.maxContent} py-4 md:py-8`}>
        <div className="space-y-6">
          ...
          <React.Suspense fallback={null}>
            ...
            {mountedTabs.has('sales_reports')  && <div className={activeTab !== 'sales_reports'  ? 'hidden' : ''}><ReportsMasterSection branch={props.branch} salesReports={props.salesReports} isLoading={props.salesReportsLoading} branches={props.branches} employees={props.employees} branchVault={props.branchVault} /></div>}
