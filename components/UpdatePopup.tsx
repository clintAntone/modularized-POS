  ...
  return (
    <div className="fixed inset-0 z-[9999] bg-slate-950/90 backdrop-blur-md flex items-center justify-center p-4">
      <div className="bg-white rounded-[32px] w-full max-w-sm p-8 text-center border border-slate-100 shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <p className="text-[9px] font-black text-emerald-600 uppercase tracking-widest mb-1">Update Required</p>
        ...
        <div className="mt-8 space-y-3">
          {apkUrl ? (
            <a
              ...
              className="flex items-center justify-center gap-2 w-full bg-slate-900 text-white font-black py-4 rounded-2xl text-[11px] uppercase tracking-widest active:scale-95 transition-all shadow-lg hover:bg-emerald-600"
            >
        ...
        <p className="text-[8px] font-bold text-slate-300 uppercase tracking-widest mt-5">
