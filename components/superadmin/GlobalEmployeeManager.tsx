        ...
        <div className="flex items-center gap-3 px-1 sm:px-2">
          ...
          <div ref={exportDropdownRef} className="relative shrink-0">
            <button
              ...
              className={`h-14 px-5 rounded-2xl bg-emerald-600 text-white flex items-center gap-2.5 text-xs font-semibold uppercase tracking-wide hover:bg-emerald-700 transition-all shadow-lg active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed`}
            >
              {isExporting ? (
            ...
            {exportDropdownOpen && (
              <div className="absolute bottom-[calc(100%+8px)] right-0 bg-white border border-slate-200 rounded-2xl shadow-xl overflow-hidden min-w-[160px] animate-in fade-in zoom-in-95 duration-150 z-[300]">
                <div className="p-1.5 space-y-0.5">
                  <button onClick={() => { setExportDropdownOpen(false); handleExportCSV(); }} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-semibold uppercase tracking-wide text-slate-700 hover:bg-teal-50 hover:text-teal-700 transition-colors">
                  ...
                  <button onClick={() => { setExportDropdownOpen(false); handleExportPDF(); }} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-xs font-semibold uppercase tracking-wide text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 transition-colors">
