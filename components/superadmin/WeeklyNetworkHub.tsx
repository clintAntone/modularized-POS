      ...
      <div className={`bg-white p-6 ${UI_THEME.radius.card} border border-slate-200 shadow-sm space-y-6`}>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button
            ...
            className="h-14 px-6 rounded-2xl bg-emerald-600 text-white flex items-center justify-center gap-2.5 text-[10px] font-black uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-lg active:scale-95"
          >
