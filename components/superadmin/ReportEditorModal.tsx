        ...
        <div className="fixed inset-0 z-[3000] bg-slate-950/60 backdrop-blur-xl flex items-center justify-center p-4">
            <div className="bg-white rounded-[40px] w-full max-w-5xl shadow-2xl flex flex-col animate-in zoom-in duration-300 overflow-hidden max-h-[90vh] border border-slate-100 print:h-auto print:max-h-none print:shadow-none print:bg-white print:border-none">
                ...
                <div className="bg-slate-50 px-8 py-4 border-b border-slate-100 grid grid-cols-2 md:grid-cols-5 gap-4 shrink-0">
                    ...
                    <div className="space-y-0.5">
                        <p className="text-xs font-black text-slate-400 uppercase tracking-widest">Expenses</p>
                        <p className="text-lg font-black text-rose-500 tabular-nums">₱{totals.expenses.toLocaleString()}</p>
                    </div>
                    <div className="space-y-0.5">
                        <p className="text-xs font-black text-slate-400 uppercase tracking-widest">Vault</p>
                ...
                <div className="flex bg-white px-8 pt-4 gap-6 shrink-0">
                    {(['sessions', 'expenses', 'vault'] as const).map(tab => (
                        <button
                            ...
                            className={`pb-4 text-xs font-black uppercase tracking-widest transition-all relative ${activeTab === tab ? 'text-slate-900' : 'text-slate-300 hover:text-slate-500'}`}
                        >
                            {tab}
                ...
                <div className="flex-1 overflow-y-auto p-8 space-y-4 no-scrollbar bg-slate-50/30">
                    <div className="flex justify-between items-center mb-4 no-print">
                        <h5 className="text-xs font-black text-slate-400 uppercase tracking-[0.2em]">Registry Entries</h5>
                        {activeTab !== 'sessions' && (
                            <button
                                onClick={() => {
                                    playSound('click');
                                ...
                                className="bg-slate-900 text-white px-4 py-2 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-emerald-600 transition-all flex items-center gap-2"
                            >
                                    ...
                                    <div className="flex flex-col md:flex-row justify-between gap-6">
                                        ...
                                        <div className="flex-1 space-y-3">
                                            <div className="flex items-center justify-between">
                                                ...
                                                {isDualRequired && (
                                                    <span className="bg-indigo-50 text-indigo-600 px-2 py-1 rounded-lg text-xs font-black uppercase tracking-widest border border-indigo-100">Dual Required</span>
                                                )}
                                            </div>
                                        ...
                                        <div className="flex-1 grid grid-cols-2 gap-4">
                                            <div className="space-y-1.5">
                                                <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Total Paid</label>
