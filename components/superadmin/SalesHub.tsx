        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 px-1 sm:px-2">
          ...
          <div className="relative shrink-0">
            <div className="flex h-9 rounded-xl overflow-hidden shadow-sm">
              <button onClick={() => { setShowExportMenu(false); setShowDownloadConfirm(true); }} className="flex items-center gap-2 px-4 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-semibold uppercase tracking-wide transition-all active:scale-95">
