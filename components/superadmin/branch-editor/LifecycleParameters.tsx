      ...
      <div className="bg-slate-50/50 p-6 rounded-[32px] space-y-8 border border-slate-100 shadow-inner">
        ...
        {cutoffChanged && (
          <div className="space-y-2 animate-in slide-in-from-top-2 duration-300">
            <label className="block text-[10px] font-semibold uppercase text-amber-600 ml-1 tracking-widest">
            ...
            <input
              ...
              className="w-full p-4 bg-amber-50 border border-amber-200 rounded-2xl font-bold text-[12px] uppercase tracking-wider text-amber-700 outline-none focus:border-amber-500 transition-all shadow-sm"
            />
            <p className="text-[9px] font-bold text-amber-500 ml-1 uppercase tracking-widest">
