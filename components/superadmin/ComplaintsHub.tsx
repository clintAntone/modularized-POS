    ...
    <div className="space-y-5">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="relative w-full sm:w-auto">
          ...
          <input
            ...
            className="w-full sm:w-52 h-9 pl-9 pr-8 bg-slate-50 border border-slate-200 rounded-2xl text-xs font-bold uppercase tracking-wider text-slate-700 placeholder:text-slate-300 outline-none focus:bg-white focus:border-slate-400 transition-all"
          />
          {searchTerm && (
      ...
      {filtered.length === 0 ? (
        <div className="py-24 text-center">
          <p className="text-xs font-bold text-slate-300 uppercase tracking-widest">No {filter !== 'ALL' ? filter.toLowerCase() : ''} complaints</p>
        </div>
      ) : (
                ...
                <div className="flex items-center gap-3 px-5 py-3.5 bg-slate-50 border-b border-slate-100">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 flex-wrap">
                      <p className="text-sm font-black text-slate-900 uppercase tracking-tight leading-none">{rep.employeeName || '—'}</p>
                      {employeeActive === false && (
                        <span className="text-xs font-black text-rose-500 bg-rose-50 px-1.5 py-0.5 rounded-lg border border-rose-100 uppercase tracking-widest">Suspended</span>
                      )}
                    </div>
                  </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-1.5 flex-wrap">
                            <span className={`text-xs font-black uppercase tracking-tight ${REPORT_TEXT_COLOR[c.reportType] || 'text-slate-600'}`}>
                              {REPORT_LABEL[c.reportType] || c.reportType || '—'}
                            </span>
                            {c.actionTaken && c.actionTaken !== 'NONE' && (
                              <span className="text-xs font-black text-emerald-600 bg-emerald-50 border border-emerald-100 px-1.5 py-0.5 rounded-md uppercase tracking-widest">
                  ...
                  <div className="bg-emerald-50 border border-emerald-100 rounded-2xl p-4 space-y-3">
                    ...
                    {c.actionTaken && c.actionTaken !== 'NONE' && (
                      <div>
                        ...
                        <p className="text-xs font-black text-emerald-800">{ACTION_LABEL_MAP[c.actionTaken] || c.actionTaken}</p>
                      </div>
                    )}
                    {c.judgment && (
                      <div>
                    ...
                    {c.reviewedBy && (
                      <p className="text-xs font-bold text-emerald-400 uppercase tracking-widest">Reviewed by {c.reviewedBy}</p>
                    )}
                  </div>
                ) : null}
              </div>
            ...
            <div className="overflow-y-auto flex-1 p-5 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {(['NONE', 'NOTED'] as EmployeeComplaint['actionTaken'][]).map(val => {
                    ...
                    return (
                      ...
                      >
                        <p className={`text-xs font-black uppercase tracking-tight leading-none ${isSelected ? 'text-slate-800' : 'text-slate-500'}`}>
                          {opt.label}
                        </p>
                      </button>
                    );
                ...
                <div className="flex items-center gap-2 py-0.5">
                  ...
                  <p className="text-xs font-black text-slate-300 uppercase tracking-widest">Escalation Track</p>
                  <div className="flex-1 h-px bg-slate-100" />
                </div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-1.5 mb-1">
                          <span className={`w-4 h-4 rounded-full text-xs font-black flex items-center justify-center shrink-0 ${isSelected ? c.num : 'bg-slate-100 text-slate-400'}`}>
                            {idx + 1}
                          </span>
                        ...
                        <p className={`text-xs font-black uppercase tracking-tight leading-tight ${isSelected ? c.text : 'text-slate-700'}`}>
                          {opt.label}
                        </p>
                      </button>
                    );
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-4 py-3 bg-slate-50 rounded-2xl text-xs font-semibold text-slate-900 placeholder:text-slate-300 outline-none border-2 border-transparent focus:border-slate-300 focus:bg-white transition-all resize-none"
                />
              </div>
            ...
            <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl overflow-hidden animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
              <div className="p-7 text-center space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  {c && <p className="text-xs font-bold text-slate-500">{c.employeeName} · {REPORT_LABEL[c.reportType] || c.reportType}</p>}
                  <p className="text-xs text-slate-400 leading-relaxed">This will mark the complaint as dismissed. This cannot be undone.</p>
                </div>
            ...
            <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl overflow-hidden animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
              <div className="p-7 text-center space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  {c && <p className="text-xs font-bold text-slate-500">{c.employeeName} · {REPORT_LABEL[c.reportType] || c.reportType}</p>}
                  <p className="text-xs text-slate-400 leading-relaxed">This will reset the complaint to pending and clear any prior action, judgment, and resolution.</p>
                </div>
                <div className="grid grid-cols-2 gap-3 pt-1">
                  <button
            ...
            <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl overflow-hidden animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
              <div className="p-7 text-center space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  {c && <p className="text-xs font-bold text-slate-500">{c.employeeName} · {REPORT_LABEL[c.reportType] || c.reportType}</p>}
                  <p className="text-xs text-slate-400 leading-relaxed">This will permanently remove the complaint record. This cannot be undone.</p>
                </div>
                <div className="grid grid-cols-2 gap-3 pt-1">
                  <button
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl overflow-hidden animate-in zoom-in-95 duration-200" onClick={e => e.stopPropagation()}>
            <div className="p-7 text-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs font-bold text-slate-500">{reviewState.complaint.employeeName} · {REPORT_LABEL[reviewState.complaint.reportType] || reviewState.complaint.reportType}</p>
                {reviewAction !== 'NONE' && (
                  <p className="text-xs text-slate-500">Action: <span className="font-black text-slate-700">{ACTION_LABEL_MAP[reviewAction] || reviewAction}</span></p>
                )}
                {reviewAction === 'SUSPENDED' && (
                  <p className="text-xs font-black text-rose-600 uppercase tracking-widest">Employee will be suspended.</p>
                )}
              </div>
              <div className="grid grid-cols-2 gap-3 pt-1">
                <button
