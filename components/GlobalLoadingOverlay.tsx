...
export const GlobalLoadingOverlay: React.FC<GlobalLoadingOverlayProps> = ({ isVisible }) => {
  ...
  return (
    <div className="fixed inset-0 z-[10000] bg-slate-950/60 backdrop-blur-sm flex items-center justify-center animate-in fade-in duration-300 no-print">
      <div className="bg-white rounded-[44px] p-10 shadow-xl flex flex-col items-center gap-6 max-w-[280px] text-center border border-white/10">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs font-medium text-slate-400 uppercase tracking-wide leading-tight">Establishing Mainframe Link over Network</p>
        </div>
      </div>
    </div>
  );
